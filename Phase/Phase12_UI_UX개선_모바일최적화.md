...
| 2 | 모바일 네비게이션 개선 | ✅ | 바텀 탭 바 (모바일) + 기존 TickerBar (데스크톱) |
| 3 | 터치 UX 최적화 | ✅ | 버튼 최소 크기 44px, 간격 확보, iOS 줌 방지 |
| 4 | 스켈레톤 UI | ✅ | SkeletonCard/Chart/Table/Text 확장 + 적용 |
| 5 | UI 일관성 다듬기 | ✅ | 폰트 크기, 간격, 카드 스타일, 숫자 폰트 통일 |
